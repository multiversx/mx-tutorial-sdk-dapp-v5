      ...
      <div className='flex flex-col gap-2'>
        <div className='flex justify-start gap-2'>
          ...
          <Button
            ...
            className='inline-block rounded-lg px-3 py-2 text-center hover:no-underline my-0 bg-blue-600 text-white hover:bg-blue-700 mr-0 disabled:bg-gray-200 disabled:cursor-not-allowed'
          >
